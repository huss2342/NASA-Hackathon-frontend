...
export const scenarios = {
  // Story Introduction Scenarios
  story1: {
    id: 'story1',
    type: 'story',
    text: `It's been a long year. In the mail you receive a rusty key and a note: "The farm is yours now, dear. I know you'll bring it back to life."`,
    next: 'story2',
  },
  story2: {
    id: 'story2',
